...
public class FieldConstants {
	...
	public static class Reef {
		...
		public static final ArrayList<Map<ReefHeight, Pose3d>> branchPositions = new ArrayList<>(13); // Starting at the right branch facing the driver station in clockwise
		...
		static {
			...
			for (int face = 0; face < 6; face++) {
				...
				for (var level : ReefHeight.values()) {
					...
					double adjustX = Units.inchesToMeters(17.738); //offsets for the left reef coral thing scoring
					double adjustY = Units.inchesToMeters(7.9);
