...
public class FieldConstants {
  ...
  public enum ReefHeight {
    ...
    ReefHeight(double height, double pitch) {
      ...
      this.pitch =
          pitch; // in degrees with 0 being facing down and positive being up toward the outside of
      // the robot
    }
  }
    ...
    static {
      ...
      for (int face = 0; face < 6; face++) {
        ...
        for (var level : ReefHeight.values()) {
          ...
          double adjustX =
              Units.inchesToMeters(17.738); // offsets for the left reef coral thing scoring
