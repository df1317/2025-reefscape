...
public class RobotContainer {
   ...
   * ---
   * This is the root class for the robot. It is responsible for configuring the
   * robot, its subsystems, and bindings.
   * ---
   */
   ...
   * created by
   * instantiating a {@link CommandButton} with a {@link Command} and then calling
   * the
  ...
  private void configureBindings() {
     ...
     * demo command will be toggled via binding and will continuially run elevator
     * positions
