...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public ClimberSubsystem() {
    ...
    HardwareLimitSwitchConfigs newHardwareLimitSwitch =
    ...
    CurrentLimitsConfigs currentConfigs =
        new CurrentLimitsConfigs().withStatorCurrentLimit(60).withStatorCurrentLimitEnable(false);
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber(
        "climber/climber current", beefyMotor.getStatorCurrent().getValueAsDouble());
