...
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    // BEGIN AKit CONFIG
    Logger.recordMetadata("ProjectName", "1317");
  ...
  /*
   * ---------- DisabledInit --- This function is called once each time the robot enters Disabled
   * mode. You can use it to reset any subsystem information you want to clear when the robot is
   * disabled. ---
   */
  @Override
  ...
  public void teleopInit() {
    /*
     * ---------- This makes sure that the autonomous stops running when teleop starts running. If
     * you want the autonomous to continue until interrupted by another command, remove this line or
     * comment it out.
     */
    if (m_autonomousCommand != null) {
